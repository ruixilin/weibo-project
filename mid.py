			...
			for link in shortLinks:
				...
				if len(re.findall("target weibo does not exist!", res.content, re.I)) == 0:
					...
					if len(user_ids) != 0:
						...
						with open('mids/mid_%s_%s_licai.txt'%(keyword,self.today), 'a') as f:
...
if __name__ == '__main__':
	...
	for i in xrange(len(lines)):
		...
		fout.close()
	'''
	uids = ['commenters/commenters_licai_20160725_nodup_0.txt\n','commenters/commenters_licai_20160725_nodup_1.txt\n','commenters/commenters_licai_20160725_nodup_2.txt\n',
	'commenters/commenters_licai_20160725_nodup_3.txt\n','commenters/commenters_licai_20160725_nodup_4.txt\n','commenters/commenters_licai_20160725_nodup_5.txt\n','commenters/commenters_licai_20160725_nodup_6.txt\n',
	'commenters/commenters_licai_20160725_nodup_7.txt\n']
	# multiprocessing
	count = 0
	plist = []
	num_users = len(users)
